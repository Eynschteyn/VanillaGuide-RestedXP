...
-----------20-21 Darkshore
    ...
    [2021] = {
        ...
        items = {
            ...
            [2] = { str = "2. First fly to Darnassus and get your new Skills." },
            [3] = { str = "3. Turn in  #TURNINOnu#  at 43,76 accept  #ACCEPTThe Master's Glaive#.", x = 43, y = 76, zone = "Darkshore" },
            [4] = { str = "4. Go to 39,85 it should say you found #DOQUESTMaster’s Glaive(complete)# now use the Phial of Scrying. Click it turn in  #TURNINThe Master's Glaive#  accept  #ACCEPTThe Twilight Camp#", x = 39, y = 85, zone = "Darkshore" },
            [5] = { str = "5. Click the Book at 38,86 turn in  #TURNINThe Twilight Camp#  accept  #ACCEPTReturn to Onu#.", x = 38, y = 86, zone = "Darkshore" },
            [6] = { str = "6. Accept  #ACCEPTTherylune's Escape  (escort)# at 38,87 and do it.", x = 38, y = 87, zone = "Darkshore" },
            [7] = { str = "7. Turn in  #TURNINThe Absent Minded Prospector pt.1#  at 35,83 accept  #ACCEPTThe Absent Minded Prospector pt.2#  and do it.", x = 35, y = 83, zone = "Darkshore" },
            [8] = { str = "8. Go west to 31,83 and 31,85 and accept  #ACCEPTBeached Sea Turtle#  at both.", x = 31, y = 83, zone = "Darkshore" },
            [9] = { str = "9. Go back to 43,76 and turn in  #TURNINReturn to Onu#  accept  #ACCEPTMathystra Relics#.", x = 43, y = 76, zone = "Darkshore" },
            [10] = { str = "10. Accept  #ACCEPTThe Sleeper Has Awakened  (escort)# the sleeping bear behind Onu. Put his horn on your hotbar because he falls asleep every minute or so. This quest will bring you into Ashenvale. Horn is in the box beside him. Note: since he follows you, with aspect of the cheetah on you can skip mobs by running down the road or taking the offroad." },
        }
    },
...
-----------21-22 Ashenvale
    ...
    [2122] = {
        ...
        items = {
            ...
            [2] = { str = "2. Run to 26,36 Maestra’s Post in Ashenvale, and this will complete  #DOQUESTThe Sleeper Has Awakened#  Go turn it in straight ahead in the house.", x = 26, y = 36, zone = "Ashenvale" },
            [3] = { str = "3. Accept  #ACCEPTBathran's Hair#." },
            [4] = { str = "4. Kill mobs around 31,31 in ruins of Ordil’Aran for  #DOQUESTThe Tower of Althalaxx pt.4#  I then clear the camp a total of 4 times. If I find it early I still clear it 4 times total. I am then half way to level 22.", x = 31, y = 31, zone = "Ashenvale" },
            [5] = { str = "5. Grab plant bundles for  #DOQUESTBathran's Hair#  at 31,21 in Bathran’s Haunt", x = 31, y = 21, zone = "Ashenvale" },
            [6] = { str = "6. Go back to Maestra’s Post at 26,38 and turn in  #TURNINThe Tower of Althalaxx pt.4#  Accept  #ACCEPTThe Tower of Althalaxx pt.5#.", x = 26, y = 36, zone = "Ashenvale" },
            [7] = { str = "7. Turn in  #TURNINBathran's Hair#  accept  #ACCEPTOrendil's Cure#." },
            [8] = { str = "8. Go to 22,51 turn in  #TURNINTherylune's Escape#.", x = 22, y = 51, zone = "Ashenvale" },
            [9] = { str = "9. Run into Astranaar at 33,48 and get FP", x = 33, y = 48, zone = "Ashenvale" },
            [10] = { str = "10. Accept  #ACCEPTThe Zoram Strand#  right as you enter town." },
            [11] = { str = "11. Accept  #ACCEPTOn Guard in Stonetalon pt.1#  on the house to the right." },
            [12] = { str = "12. Cross the road near the gazebo accept  #ACCEPTJourney to Stonetalon Peak#" },
            [13] = { str = "13. In the Inn accept  #ACCEPTRaene's Cleansing pt.1#  and  #ACCEPTCulling the Threat#." },
            [14] = { str = "14. Make Astranaar your home. #HUTNERThen Stable your pet#" },
            [15] = { str = "15. Turn in  #TURNINOrendil's Cure#  at the last house accept  #ACCEPTElune's Tear#" },
            [16] = { str = "16. Go to The Zoram Strand. Stop at 14,31 accept  #ACCEPTThe Ancient Statuette#", x = 14, y = 31, zone = "Ashenvale" },
            [17] = { str = "17. #HUNTERTame a Clattering Crawler lvl 20 to get Claw Rank 3 give it Growl 3#"},
            [18] = { str = "18. #DOQUESTThe Zoram Strand#  Naga all around here." },
            [19] = { str = "19. And  #DOQUESTThe Ancient Statuette#  at 14,20 it’s on the ground. ", x = 14, y = 20, zone = "Ashenvale" },
            [20] = { str = "20. Turn in  #TURNINThe Ancient Statuette#  at 14,31 accept  #ACCEPTRuuzel#", x = 14, y = 31, zone = "Ashenvale" },
            [21] = { str = "21. Do  #DOQUESTRuuzel#  at 9,15 You don’t actually have to kill Ruuzel. Kill Lady Vespia. A 22 weak elite and doesn’t have guards like Ruuzel", x = 9, y = 15, zone = "Ashenvale" },
            [22] = { str = "22. Turn in  #TURNINRuuzel#  at 14,20.", x = 14, y = 20, zone = "Ashenvale" },
            [23] = { str = "23. Turn in  #TURNINRaene's Cleansing pt.1#  at 20,42 accept  #ACCEPTRaene’s Cleansing pt.2#  Kill murlocs for the gem", x = 20, y = 42, zone = "Ashenvale" },
            [24] = { str = "24. Hearth back to Astranaar" },
            [25] = { str = "25. Turn in  #TURNINThe Zoram Strand#  right as you enter town accept  #ACCEPTPridewings of Stonetalon#" },
            [26] = { str = "26. Go to the Inn Turn in  #TURNINRaene’s Cleansing pt.2#  accept  #ACCEPTRaene’s Cleansing pt.3#  and  #ACCEPTAn Aggressive Defense#" },
            [27] = { str = "27. Grind to 46,46 and accept  #ACCEPTElune's Tear#", x = 46, y = 46, zone = "Ashenvale" },
            [28] = { str = "28. Go to 49,56 then grind north to 53,46 turn in  #TURNINRaene’s Cleansing pt.3#  accept  #ACCEPTRaene’s Cleansing pt.4#.", x = 49, y = 56, zone = "Ashenvale" },
            [29] = { str = "29. You should already be level 22. Go to 55,61 and do  #DOQUESTAn Aggressive Defense#", x = 55, y = 61, zone = "Ashenvale" },
            [30] = { str = "30. Hearth to Astranaar" },
            [31] = { str = "31. Turn in  #TURNINAn Aggressive Defense#" },
            [32] = { str = "32. Go to the east exit house, turn in  #TURNINElune's Tear#  accept  #ACCEPTThe Ruins of Stardust#" },
            [33] = { str = "33. Exit Astranaar out the east exit follow the south path till you are at 33,66 and grab stardust covered bushes for  #DOQUEATThe Ruins of Stardust#", x = 33, y = 66, zone = "Ashenvale" },
            [34] = { str = "34. Grind east to Talondeep path at 42,71", x = 42, y = 71, zone = "Ashenvale" },
        }
    },
...
-----------22-23 Stonetalon Mountains
    ...
    [2223] = {
        ...
        items = {
            ...
            [2] = { str = "2. Run down Stonetalon to the hut at 58,62 accept  #ACCEPTSuper Reaper 6000#", x = 58, y = 62, zone = "Stonetalon Mountains" },
            [3] = { str = "3. Then go to 59,66 and turn in  #TURNINOn Guard in Stonetalon pt.1#  accept  #ACCEPTOn Guard in Stonetalon pt.2#.", x = 59, y = 66, zone = "Stonetalon Mountains" },
            [4] = { str = "4. Turn it in right behind you accept  #ACCEPTA Gnome’s Respite#" },
            [5] = { str = "5. Kill Loggers and Deforesters for  #DOQUESTA Gnome’s Respite#  and Operators for  #DOQUESTSuper Reaper 6000#  all around Windshear Crag. Operators hang out around buildings only." },
            [6] = { str = "6. Turn in  #TURNINSuper Reaper 6000#  at the hut 58,62 SKIP  #VIDEOFurther Instructions#  Unless you want to run to Ratchet.", x = 58, y = 62, zone = "Stonetalon Mountains" },
            [7] = { str = "7. Then go to 59,66 and turn in  #TURNINA Gnome’s Respite#  accept  #ACCEPTAn Old Colleague#  and  #ACCEPTA Scroll From Mauren#  We’ll do these later.", x = 59, y = 66, zone = "Stonetalon Mountains" },
            [8] = { str = "8. Stop at Mirkfallon Lake at 48,40 and kill Pridewings for  #NPCPridewings of Stonetalon#  South and East of it.", x = 48, y = 40, zone = "Stonetalon Mountains" },
            [9] = { str = "9. Run to 37,8 turn in  #TURNINJourney to Stonetalon Peak#  SKIP  #VIDEOReclaiming The Charred Vale#  for now", x = 37, y = 8, zone = "Stonetalon Mountains" },
            [10] = { str = "10. Grab FP at 36,7 and Fly to Auberdine.", x = 36, y = 7, zone = "Stonetalon Mountains" },
        }
    },
