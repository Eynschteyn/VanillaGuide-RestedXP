...
-----------1-6 Teldrassil
	...
	[0106] = {
		...
		items = {
			...
			[20] = { str = "20. Подойдите к эльфу по пути и сдайте задание #TURNINWebwood Venom#  в точке и берите 57,41. Берите следующее #ACCEPTWebwood Egg#
			[21] = { str = "21. Бегите к пешере и эльфу отшельнику сдайте задание на время #TURNINIverron's Antidote pt.2# в точке 54,33
			[22] = { str = "22. Найдите яйцо в глубине паучей пещеры яйцо для задания #DOQUESTWebwood Egg#
			[23] = { str = "23. 
			[24] = { str = "24.
			[25] = { str = "25.
			[26] = { str = "26.
