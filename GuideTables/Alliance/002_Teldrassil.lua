...
-----------1-6 Teldrassil
	...
	[0106] = {
		...
		items = {
			...
			[3] = { str = "3. Берите задание  #ACCEPTThe Woodland Protector pt.1#  и  #ACCEPTA Good Friend#" },
			...
			[7] = { str = "7. Сдайте задание козе  #TURNINThe Woodland Protector pt.1#  и возьмите  #ACCEPTThe Woodland Protector pt.2#" },
			...
			[10] = { str = "10. Идите внутрь и продайте мусор торговцу и купите что нужно стрелы 3 пака и т.д." },
			[11] = { str = "11. Берите задание  #ACCEPTWebwood Venom#. у эльфа в точке 57,41" },
			[12] = { str = "12. Гриндите мобов пока до 4 уровня не останется 40 очков опыта." },
			...
			[19] = { str = "19. Заскачите к НПС в точке ??????    у которого ранее продовали мусор или покупали стрелы и купите 3-4 пака стрелл" },
