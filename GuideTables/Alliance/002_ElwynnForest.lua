...
-----------1-10 Elwynn Forest
	...
	[0110] = {
		...
		items = {
			...
			[6] = { str = "6. Go back to 48,40 and turn in #TURNINWolves Across the Border#", x = 48, y = 40, zone = "Elwynn Forest" },
			[7] = { str = "7. Run into the house at 48,41 and turn in #TURNINKobold Camp Cleanup# accept #ACCEPTSimple Letter# and #ACCEPTInvestigate Echo Ridge#", x = 48, y = 41, zone = "Elwynn Forest" },
			[8] = { str = "8. Go to your class trainer and turn in #TURNINSimple Letter# and get new skills", x = 50, y = 42, zone = "Elwynn Forest" },
			[9] = { str = "9. Exit the house and accept #ACCEPTBrotherhood of Thieves#" },
			[10] = { str = "10. Go NW toward the cave at 47,32 and kill Kobold Workers on the way for #DOQUESTInvestigate Echo Ridge#", x = 47, y = 32, zone = "Elwynn Forest" },
			[11] = { str = "11. Go West to 54,40 and go south killing the defias for #DOQUESTBrotherhood of Thieves# you should be level 4 by the time you’re done, if not just grind until you are", x = 54, y = 40, zone = "Elwynn Forest" },
			[12] = { str = "12. Run back to the abbey at 48,42 and turn in #TURNINBrotherhood of Thieves# accept #ACCEPTMilly Osworth# and #ACCEPTBounty on Garrick Padfoot#", x = 48, y = 42, zone = "Elwynn Forest" },
			[13] = { str = "13. Go inside the house and turn in #TURNINInvestigate Echo Ridge# accept #ACCEPTSkirmish at Echo Ridge# then get new skills" },
			[14] = { str = "14. Go north of the house at 50,39 next to the barn, turn in #TURNINMilly Osworth# accept #ACCEPTMilly's Harvest#", x = 50, y = 39, zone = "Elwynn Forest" },
			[15] = { str = "15. Go back east and grab the grapes in the garden at 54,48 for #DOQUESTMilly's Harvest# then NE to 57,48 you’ll see a shack with padfoot and a thug. Kill him for #DOQUESTBounty on Garrick Padfoot#", x = 57, y = 48, zone = "Elwynn Forest" },
			[16] = { str = "16. Go back to 50,39 and turn in #TURNINMilly's Harvest# accept #ACCEPTGrape Manifest#", x = 50, y = 39, zone = "Elwynn Forest" },
			[17] = { str = "17. Go into the cave at 47,31 and kill Kobold Laborer’s for #DOQUESTSkirmish at Echo Ridge#", x = 47, y = 31, zone = "Elwynn Forest" },
			[18] = { str = "18. Hearth back to the Abbey" },
			[19] = { str = "19. Turn in #TURNINBounty on Garrick Padfoot#" },
			[20] = { str = "20. Go inside the house, turn in #TURNINSkirmish at Echo Ridge# accept #ACCEPTReport to Goldshire#" },
			[21] = { str = "21. Go to the top of the tower through the spiral staircase, turn in #TURNINGrape Manifest#" },
			[22] = { str = "22. Go to 45,47 and accept #ACCEPTRest and Relaxation#", x = 45, y = 47, zone = "Elwynn Forest" },
			[23] = { str = "23. If you’re not level 6 you should be close, just grind on a few mobs while you head towards the house near Goldshire at 46,62 and pick up skinning if you want it", x = 46, y = 42, zone = "Elwynn Forest" },
			[24] = { str = "24. Enter the Inn at 42,65", x = 42, y = 65, zone = "Elwynn Forest" },
			[25] = { str = "25. Accept #ACCEPTKobold Candles#" },
			[26] = { str = "26. Near the bar turn in #TURNINRest and Relaxation# and make Goldshire your home" },
			[27] = { str = "27. Exit the Inn, turn in #TURNINReport to Goldshire# accept #ACCEPTThe Fargodeep Mine#" },
			[28] = { str = "28. Find your trainer and buy new skills." },
			[29] = { str = "29. Go near the carts at 42,67 and accept #ACCEPTGold Dust Exchange#", x = 42, y = 67, zone = "Elwynn Forest" },
			...
			[43] = { str = "43. Turn around by the blacksmith and turn it in, accept #ACCEPTFurther Concerns#" },
			[44] = { str = "44. Kill murlocs around the lake at 51,65 for #DOQUESTCollecting Kelp#", x = 51, y = 65, zone = "Elwynn Forest" },
			[45] = { str = "45. Grind up to the Jasperlode Mine at 61,53 and run through it about half way to 60,50 for #DOQUESTThe Jasperlode Mine#", x = 60, y = 50, zone = "Elwynn Forest" },
			[46] = { str = "46. Run to the bridge at 73,72 and turn in #TURNINFurther Concerns# accept #ACCEPTFind the Lost Guards# and #ACCEPTProtect the Frontier#", x = 73, y = 72, zone = "Elwynn Forest" },
			[47] = { str = "47. Stop at the house NE of here at 79,68 and accept #ACCEPTRed Linen Goods#", x = 79, y = 68, zone = "Elwynn Forest" },
			[48] = { str = "48. At the center of the camp, 81,66, accept #ACCEPTA Bundle of Trouble#", x = 81, y = 66, zone = "Elwynn Forest" },
